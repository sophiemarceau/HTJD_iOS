...
//        _menuColor = [UIColor colorWithRed:128/255.0 green:128/255.0 blue:128/255.0 alpha:1.0];
        _menuColor = UIColorFromRGB(0xAE9385);
        _array = array;
...
//                CAShapeLayer *separator = [self creatSeparatorLineWithColor:[UIColor colorWithRed:239.0/255.0 green:239.0/255.0 blue:243.0/255.0 alpha:1.0] andPosition:separatorPosition];
                CAShapeLayer *separator = [self creatSeparatorLineWithColor:UIColorFromRGB(0xECE6DD) andPosition:separatorPosition];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.textLabel setTextColor:UIColorFromRGB(0xAE9385)];
    [cell setAccessoryType:UITableViewCellAccessoryNone];
    
//    NSLog(@"_array-------->%@",_array);
    cell.textLabel.text = _array[_currentSelectedMenudIndex][indexPath.row]==[NSNull null]?@"":_array[_currentSelectedMenudIndex][indexPath.row];
...
//    }
    if ([cell.textLabel.text  isEqualToString:nowSelectTitle]) {
        [cell setAccessoryType:UITableViewCellAccessoryCheckmark];
        [cell.textLabel setTextColor:[tableView tintColor]];
    }
...
- (UITableView *)creatTableViewAtPosition:(CGPoint)point
{
    ...
    [tableView setSeparatorColor:UIColorFromRGB(0xdcd5ca)];
    return tableView;
}
...
//    title.string = [[_array objectAtIndex:_currentSelectedMenudIndex] objectAtIndex:row];
     nowSelectTitle = [[_array objectAtIndex:_currentSelectedMenudIndex] objectAtIndex:row];
