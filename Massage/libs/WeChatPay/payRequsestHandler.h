...
#define APP_ID          @"wx9812707fd136e8bb"               //APPID
#define APP_SECRET      @"9e755f01725602288079b6d3d18f4bd0" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1227289401"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"42d5362f94eef541c710ef19fb35ffbe"
//支付结果回调页面
