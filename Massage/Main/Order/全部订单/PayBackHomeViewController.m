...
@interface PayBackHomeViewController ()<UIAlertViewDelegate>

@end

@implementation PayBackHomeViewController
{
...
//        self.payScrollView.contentSize = CGSizeMake(kScreenWidth, 721);//695-48
