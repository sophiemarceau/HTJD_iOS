...
@interface PayBackStoreViewController ()<UIAlertViewDelegate>

@end

@implementation PayBackStoreViewController
{
...
#pragma mark - 添加约束(消费码部分)
    ...
    UILabel *alreadyLabel = [CommentMethod initLabelWithText:@"已退款" textAlignment:NSTextAlignmentRight font:14];
    alreadyLabel.textColor = RedUIColorC1;
...
//        self.payScrollView.contentSize = CGSizeMake(kScreenWidth, 742);//695-48
...
- (UILabel *)payCodeLabel {
    if (_payCodeLabel == nil) {
        self.payCodeLabel = [CommentMethod initLabelWithText:@"1241245625352531" textAlignment:NSTextAlignmentLeft font:14];
    }
