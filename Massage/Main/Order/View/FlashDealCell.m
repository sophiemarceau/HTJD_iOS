...
-(void)layoutSubviews{
    ...
    [rightImage mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.storeNameLabel.mas_right).with.offset(25);
...
//    }];
    ...
    [self.addressLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.serviceNameLabel.mas_bottom).offset(6.5);
        make.right.equalTo(self.backView.mas_right).offset(-10);
...
//    }
    ...
    [self.IWantButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(line3.mas_bottom).offset(13);
...
- (UILabel *)waitingForLabel {
    if (_waitingForLabel == nil) {
        ...
        self.waitingForLabel.textColor = UIColorFromRGB(0xE99120);
    }
...
- (UIImageView *)homeOrStoreImageView {
    if (_homeOrStoreImageView == nil) {
        ...
        self.homeOrStoreImageView.image = [UIImage imageNamed:@"icon_order_home"];
    }
