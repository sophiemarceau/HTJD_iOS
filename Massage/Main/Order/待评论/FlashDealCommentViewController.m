//
//  FlashDealCommentViewController.m
//  Massage
//
...
@interface FlashDealCommentViewController ()

@end

@implementation FlashDealCommentViewController
{
...
#pragma mark - 添加约束(我要评论部分)
    ...
    [self.commentButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.commentView.mas_centerY);
        make.left.equalTo(self.commentView.mas_left).offset(10);
        make.right.equalTo(self.commentView.mas_right).offset(-10);
        make.height.mas_equalTo(40*AUTO_SIZE_SCALE_X);
    }];
    UIImageView *line2 = [[UIImageView alloc]init];
    line2.backgroundColor = UIColorFromRGB(0xB2B2B3);
    [self.commentView addSubview:line2];
