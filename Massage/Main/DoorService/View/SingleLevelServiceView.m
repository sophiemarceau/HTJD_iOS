...
@implementation SingleLevelServiceView
...
//    [self addSubview:self.contentView];
//    
//    UIFont *font = [UIFont fontWithName:@"Arial" size:15*AUTO_SIZE_SCALE_X];
...
//    }
//    
//    CGSize labelsize = [moneyStr sizeWithFont:font constrainedToSize:size lineBreakMode:NSLineBreakByWordWrapping];
//    
//    self.PriceLabel.frame = CGRectMake(self.Price1Label.origin.x+self.Price1Label.frame.size.width, self.Price1Label.frame.origin.y-3*AUTO_SIZE_SCALE_X, labelsize.width, labelsize.height);
//    
//    self.PriceLabel.text =moneyStr;
//    
////    self.Price2Label.frame = CGRectMake(self.PriceLabel.frame.origin.x+self.PriceLabel.frame.size.width, self.titleLabel.frame.origin.y+self.titleLabel.frame.size.height+12.0f*AUTO_SIZE_SCALE_X, 12.0f*AUTO_SIZE_SCALE_X, 12.0f*AUTO_SIZE_SCALE_X);
//    
//    UIFont *font1 = [UIFont fontWithName:@"Arial" size:11*AUTO_SIZE_SCALE_X];
//    NSString *markStr =[NSString stringWithFormat:@"%@",[self.dataDic objectForKey:@"score"]];
//    
//    CGSize marksize = [markStr sizeWithFont:font1 constrainedToSize:size lineBreakMode:NSLineBreakByWordWrapping];
...
//    self.remarkPriceLabel.frame = CGRectMake(self.PriceLabel.frame.origin.x+self.PriceLabel.frame.size.width+6, self.PriceLabel.frame.origin.y+2, remarkPriceLabelSize.width, 15.0f*AUTO_SIZE_SCALE_X);
//    [self.contentView addSubview:self.remarkPriceLabel];
...
//        
//        self.Price1Label.frame = CGRectMake(10, self.titleLabel.frame.origin.y+self.titleLabel.frame.size.height+12.0f*AUTO_SIZE_SCALE_X, 10.0f, 12.0f*AUTO_SIZE_SCALE_X);
//        
//    }
//    return _Price1Label;
//}
...
//        _PriceLabel.font=[UIFont boldSystemFontOfSize:15*AUTO_SIZE_SCALE_X];
