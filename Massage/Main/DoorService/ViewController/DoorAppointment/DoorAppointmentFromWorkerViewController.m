//
//  DoorAppointmentFromWorkerViewController.m
//  Massage
//
...
@interface DoorAppointmentFromWorkerViewController ()<UITextViewDelegate,UIAlertViewDelegate>
{
...
@implementation DoorAppointmentFromWorkerViewController
...
- (void)viewDidLoad {
    ...
    couponID = @"";
    isWithBed = @"0";
    workerID = [self.serviceInfoDic objectForKey:@"workerID"];
    gradeID = [self.serviceInfoDic objectForKey:@"workerGradeID"];
...
#pragma mark 服务项目信息
    serviceView = [[UIView alloc] initWithFrame:CGRectMake(0, 10*AUTO_SIZE_SCALE_X, kScreenWidth, 130*AUTO_SIZE_SCALE_X)];
    serviceView.backgroundColor = [UIColor whiteColor];
    [headerView addSubview:serviceView];
    
    selectWorkerLabel = [[UILabel alloc] initWithFrame:CGRectMake(10*AUTO_SIZE_SCALE_X, 0*AUTO_SIZE_SCALE_X, kScreenWidth, 40*AUTO_SIZE_SCALE_X)];
    selectWorkerLabel.text = [NSString stringWithFormat:@"技师: %@",[self.serviceInfoDic objectForKey:@"workerName"]];
    selectWorkerLabel.font = [UIFont systemFontOfSize:14];
    [serviceView addSubview:selectWorkerLabel];
    
    UIImageView * selectWorkerLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, selectWorkerLabel.frame.origin.y+selectWorkerLabel.frame.size.height, kScreenWidth, 0.5)];
    selectWorkerLine.image = [UIImage imageNamed:@"icon_zhixian"];
    [serviceView addSubview:selectWorkerLine];
    
    
    UIImageView * touxiangImv = [[UIImageView alloc] initWithFrame:CGRectMake(10*AUTO_SIZE_SCALE_X, selectWorkerLine.frame.origin.y+selectWorkerLine.frame.size.height+10*AUTO_SIZE_SCALE_X, 66*AUTO_SIZE_SCALE_X, 66*AUTO_SIZE_SCALE_X)];
    ...
    UILabel * nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(touxiangImv.frame.origin.x+touxiangImv.frame.size.width+10*AUTO_SIZE_SCALE_X, selectWorkerLine.frame.origin.y+selectWorkerLine.frame.size.height+10*AUTO_SIZE_SCALE_X, 220*AUTO_SIZE_SCALE_X, 16*AUTO_SIZE_SCALE_X)];
...
#pragma mark 填写服务信息
    ...
    //服务地址View
//    UIView * servPlaceView = [[UIView alloc] initWithFrame:CGRectMake(0, servTimeView.frame.origin.y+servTimeView.frame.size.height, kScreenWidth, 45*AUTO_SIZE_SCALE_X)];//无地址45，有地址87
...
//            kehuSex = @"女士";
//        }
//        kehuInfoLabel = [[UILabel alloc] initWithFrame:CGRectMake(servPlaceLabel.frame.origin.x+servPlaceLabel.frame.size.width, selectPlaceLabel.frame.origin.y+selectPlaceLabel.frame.size.height+13*AUTO_SIZE_SCALE_X, 185*AUTO_SIZE_SCALE_X, 15*AUTO_SIZE_SCALE_X)];
...
//    
//    UIImageView * servPlaceLine = [[UIImageView alloc] initWithFrame:CGRectMake(13*AUTO_SIZE_SCALE_X, 45*AUTO_SIZE_SCALE_X-1, kScreenWidth-13*AUTO_SIZE_SCALE_X, 1)];
//    if (havedefaultAddress) {
...
//    [servPlaceView addSubview:servPlaceLine];
    ...
    //不是自营男技师时高度为0，是自营男技师时为110
    if ([[NSString stringWithFormat:@"%@",[self.serviceInfoDic objectForKey:@"isSelfOwned"] ] isEqualToString:@"1"]&&[[NSString stringWithFormat:@"%@",[self.serviceInfoDic objectForKey:@"sitType"] ]isEqualToString:@"1"]&&[[self.serviceInfoDic objectForKey:@"gender"] isEqualToString:@"男"]) {
        bedView = [[UIView alloc] initWithFrame:CGRectMake(0, servPlaceView.frame.origin.y+servPlaceView.frame.size.height, kScreenWidth, 110*AUTO_SIZE_SCALE_X)];
        servPlaceLine.hidden = YES;
    }else{
        bedView = [[UIView alloc] initWithFrame:CGRectMake(0, servPlaceView.frame.origin.y+servPlaceView.frame.size.height, kScreenWidth, 0)];
    }
...
//    [bedView addGestureRecognizer:bedViewTap];
    ...
    UIView * bedBgView = [[UIView alloc] initWithFrame:CGRectMake(0, 10*AUTO_SIZE_SCALE_X, kScreenWidth, 50*AUTO_SIZE_SCALE_X)];
