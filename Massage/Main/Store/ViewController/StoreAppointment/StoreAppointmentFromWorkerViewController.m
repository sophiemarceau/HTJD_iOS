//
//  StoreAppointmentFromWorkerViewController.m
//  Massage
//
...
@interface StoreAppointmentFromWorkerViewController ()<UITextViewDelegate,UIAlertViewDelegate>
{
...
@implementation StoreAppointmentFromWorkerViewController
...
- (void)viewDidLoad {
    ...
    self.titles = @"预约到店";
    selectTimeStr = @"";
    workerID = [NSString stringWithFormat:@"%@",[self.serviceInfoDic objectForKey:@"workerID"]];
...
#pragma mark 服务项目信息
    ...
    UILabel * workerLabel = [[UILabel alloc] initWithFrame:CGRectMake(10*AUTO_SIZE_SCALE_X, (40-14)*AUTO_SIZE_SCALE_X/2, 0, 14*AUTO_SIZE_SCALE_X)];
    workerLabel.text = [NSString stringWithFormat:@"技师 :  %@",[self.serviceInfoDic objectForKey:@"workerName"]];
    workerLabel.font = [UIFont systemFontOfSize:14];
    CGSize workerLabelSize = [workerLabel intrinsicContentSize];
    workerLabel.frame = CGRectMake(10*AUTO_SIZE_SCALE_X, (40-14)*AUTO_SIZE_SCALE_X/2, workerLabelSize.width, 14*AUTO_SIZE_SCALE_X);
    [serviceView addSubview:workerLabel];
    
    UIImageView * workerLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, 40*AUTO_SIZE_SCALE_X-0.5, kScreenWidth, 0.5)];
    workerLine.image = [UIImage imageNamed:@"icon_zhixian"];
    [serviceView addSubview:workerLine];
    
    
    UIImageView * touxiangImv = [[UIImageView alloc] initWithFrame:CGRectMake(10*AUTO_SIZE_SCALE_X, (10+40)*AUTO_SIZE_SCALE_X, 66*AUTO_SIZE_SCALE_X, 66*AUTO_SIZE_SCALE_X)];
    ...
    UILabel * nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(touxiangImv.frame.origin.x+touxiangImv.frame.size.width+10*AUTO_SIZE_SCALE_X, (10+40)*AUTO_SIZE_SCALE_X, 220*AUTO_SIZE_SCALE_X, 16*AUTO_SIZE_SCALE_X)];
...
#pragma mark 服务等级
    gradeView = [[UIView alloc] initWithFrame:CGRectMake(0, serviceView.frame.origin.y+serviceView.frame.size.height, kScreenWidth, 0)];
...
#pragma mark 优惠券
    couponView = [[UIView alloc] initWithFrame:CGRectMake(0, servTimeView.frame.origin.y+servTimeView.frame.size.height, kScreenWidth, 90*AUTO_SIZE_SCALE_X)];
    ...
    //    }else{
    //        selectCouponLabel.text = [NSString stringWithFormat:@"%@",@"暂无可用的优惠券"];
...
#pragma mark 总计
    ...
    if (CouponListArray.count > 0) {
        ...
        couponShowLabel.textAlignment = NSTextAlignmentLeft;
...
//
//    NSString * moneyStr = [NSString stringWithFormat:@"¥%@",[[servGradeListArray objectAtIndex:sender.tag-1] objectForKey:@"gradePrice"]];
//    NSMutableAttributedString * attMoneyStr = [[NSMutableAttributedString alloc] initWithString:moneyStr];
//    [attMoneyStr addAttribute:NSFontAttributeName
//                        value:[UIFont systemFontOfSize:9]
//                        range:NSMakeRange(0, 1)];
...
//
//
//    NSString * temoneyStr = [NSString stringWithFormat:@"特价 ¥%@",[[servGradeListArray objectAtIndex:sender.tag-1] objectForKey:@"marketPrice"]];
//    NSMutableAttributedString * attTemoneyStr  = [[NSMutableAttributedString alloc] initWithString:temoneyStr];
//    [attTemoneyStr addAttribute:NSFontAttributeName
//                          value:[UIFont systemFontOfSize:12]
...
//    [attTemoneyStr addAttribute:NSFontAttributeName
//                          value:[UIFont systemFontOfSize:9]
//                          range:NSMakeRange( 2,temoneyStr.length-2)];
//    [attTemoneyStr addAttribute:NSForegroundColorAttributeName
//                          value:C6UIColorGray
//                          range:NSMakeRange(0, temoneyStr.length)];
//    [attTemoneyStr addAttribute:NSStrikethroughStyleAttributeName
